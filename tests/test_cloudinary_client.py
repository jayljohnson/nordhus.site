...
from clients.cloudinary_client import CloudinaryClient, CloudinaryHasher
...
class TestCloudinaryClient:
    ...
    def test_download_image(self, mock_open, mock_makedirs, mock_requests, cloudinary_client):
        ...
        # Test download
        result = cloudinary_client.download_image(
...
class TestCloudinaryHasher:
    ...
    def test_generate_image_hash(self):
        ...
        image = {
            'id': 'test-project/image1',
            'url': 'https://example.com/image1.jpg',
            'metadata': {'datetime': '2025-01-01T12:00:00Z'}
        }
